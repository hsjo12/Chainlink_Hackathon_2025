...
import { Calendar, MapPin, Clock, Ticket, QrCode, Sparkles, Star, Zap } from "lucide-react";
...
export const TicketCard = ({
  ...
  return (
      ...
      >
        ...
        {image && (
          <motion.div
            className="absolute top-0 left-0 right-0 h-48 z-30 overflow-hidden"
        ...
        <motion.div
          ...
          style={{
            marginTop: image ? "192px" : "0px",
            padding: image ? "24px 32px 32px" : "32px",
          }}
          animate={{
            z: 2
          }}
        >
          ...
          >
            ...
            <motion.div
              className="text-sm mb-4 space-y-2"
              initial={{ filter: "blur(3px)", opacity: 0.7 }}
              animate={{
            ...
            >
              ...
              <div className="flex items-center gap-2 text-gray-300">
                ...
                {typeof startDateTime !== 'string' ? (
                  <span className="text-xs">{startDateTime.date} at {startDateTime.time}</span>
                ) : (
              ...
              <div className="flex items-center gap-2 text-gray-300">
                ...
                <span className="text-xs">
                  ...
                  {seatNumber && seatNumber !== section && ` • Seat ${seatNumber}`}
                </span>
              </div>
            </motion.div>
