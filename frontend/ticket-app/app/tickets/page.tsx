    ...
    },
    {
        ...
        tickets: [
            ...
            },
            {
                ...
                type: "Investor Pass",
                price: 150,
                benefits: "Premium seating, exclusive networking reception, and pitch deck access.",
                quantity: 30
            }
        ]
    }
                    ...
                    if (foundEvent) {
                        ...
                        if (foundEvent.tickets && Array.isArray(foundEvent.tickets)) {
                            const formattedTickets = foundEvent.tickets.map((ticket: any, index: number) => ({
                                ...
                                type: ticket.type,
                                price: ticket.price,
                                benefits: defaultBenefits[ticket.type as keyof typeof defaultBenefits] || 
    ...
    return (
        <main className="min-h-screen bg-white p-6">
            ...
            <section className="text-center mb-12">
                ...
                {event && (
                    <p className="text-gray-600 text-lg">Choose a ticket type for {event.title}</p>
                )}
            </section>
                    ...
                    {tickets.map((ticket) => (
                        ...
                        >
                            <CardContent className="p-6 flex flex-col items-center text-center">
                                ...
                                <p className="text-2xl font-bold text-blue-600 mb-2">{formatPrice(ticket.price)}</p>
