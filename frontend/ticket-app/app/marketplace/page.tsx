...
const calculatePopularity = () => {
  ...
  return Object.entries(eventCounts).map(([type, count]) => ({
    ...
    percentage: Math.round(
      (count /
        ticketData.reduce((sum, ticket) => sum + ticket.ticketsSold, 0)) *
        100
    ),
  }));
};
    ...
    <main className="min-h-screen bg-white p-6">
      ...
      <section className="text-center mb-8">
        ...
        <p className="text-gray-600 text-lg mb-4">
          Browse available tickets for upcoming events
        </p>
        ...
        <div className="flex justify-center gap-2 mb-6">
          ...
          <select
            ...
            onChange={(e) =>
              setSelectedCurrency(e.target.value as keyof typeof currencyRates)
            }
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-2xl font-bold text-blue-600">
                      {selectedCurrency}{" "}
                      {convertPrice(ticket.price, selectedCurrency)}
                    </p>
                  </div>
                  <p className="text-sm text-gray-500">
                    Tickets Sold: {ticket.ticketsSold}
                  </p>
                </div>
              </CardContent>
      ...
      {selectedTicket && (
        <PurchasePopup
          ...
          ticketInfo={{
            ...
            price: parseFloat(
              convertPrice(selectedTicket.price, selectedCurrency)
            ),
